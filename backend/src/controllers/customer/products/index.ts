import { CustomerProductWebApi } from '@web-api';
import { createController, getCommonQuery } from '@utils/controllers';
import { ErrorResponse } from '@utils/error-handler';
import * as productModel from '@models/products';

export const getProducts = createController<CustomerProductWebApi.GetProducts>(
  async (req, res) => {
...
export const getProduct = createController<CustomerProductWebApi.GetProduct>(
  async (req, res) => {
